...
describe('MockBackend Community', () => {
    ...
    it('get_all_communities() should query current service url', fakeAsync(() => {
    ...
    it('get_all_communities() should return a list of communities', fakeAsync(() => {
        ...
        expect(result[1].id).toEqual(2, ' id of community 2 should be 2');
    ...
    it('get_community_surrounding() should return a community', fakeAsync(() => {
        ...
        this.lastConnection.mockRespond(new Response(new ResponseOptions({
            body: JSON.stringify(
                new Community(77, "Waterfront Communities-The Island", [[[[43.643911, -79.376321], [43.644268, -79.372738], [43.642071, -79.37262], [43.641993, -79.375881], [43.643911, -79.376321]]]]))
        })));
